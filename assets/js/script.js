...
// evento do botão reproduzir ou pausar
playPauseBtn.addEventListener("click", () => {
    const isMusicPaused = wrapper.classList.contains("paused");
    isMusicPaused ? pauseMusic() : playMusic();
    playingNow();
});
//próximo evento de botão da musica
nextBtn.addEventListener("click", () => {
    nextMusic();
});
//evento do botao de voltar musica
prevBtn.addEventListener("click", () => {
    prevMusic();
});
// atualiza o progresso da barra de acordo o tempo atual da musica
mainAudio.addEventListener("timeupdate", (e) => {
    ...
    mainAudio.addEventListener("loadeddata",() => {
        // atualiza duração total da musica
        ...
        // atualiza a hora atual da musica tocando
...
repeatBtn.addEventListener("click", () => {
    ...
    switch(getText){
        case "repeat":
            ...
            repeatBtn.setAttribute("title", "Repetir musica");
            break;
        case "repeat_one":
